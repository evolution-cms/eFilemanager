...
<head>
  ...
  @php
    ...
    if (is_file($scriptPath)) {
      $assetVersion = (string) filemtime($scriptPath);
    }
    $assetSuffix = $assetVersion !== '' ? '?v=' . $assetVersion : '';
  @endphp
  <link rel="shortcut icon" type="image/png" href="{{ asset('vendor/laravel-filemanager/img/72px color.png' . $assetSuffix) }}">
  ...
  <link rel="stylesheet" href="{{ asset('vendor/laravel-filemanager/css/cropper.min.css' . $assetSuffix) }}">
  <link rel="stylesheet" href="{{ asset('vendor/laravel-filemanager/css/dropzone.min.css' . $assetSuffix) }}">
  <link rel="stylesheet" href="{{ asset('vendor/laravel-filemanager/css/mime-icons.min.css' . $assetSuffix) }}">
  <style>{!! \File::get(base_path('vendor/unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style>
  {{-- Use the line below instead of the above if you need to cache the css. --}}
  {{-- <link rel="stylesheet" href="{{ asset('/vendor/laravel-filemanager/css/lfm.css' . $assetSuffix) }}"> --}}
</head>
<body>
  ...
  <script src="{{ asset('vendor/laravel-filemanager/js/cropper.min.js' . $assetSuffix) }}"></script>
  <script src="{{ asset('vendor/laravel-filemanager/js/dropzone.min.js' . $assetSuffix) }}"></script>
  <script>
  ...
  {{-- <script src="{{ asset('vendor/laravel-filemanager/js/script.js' . $assetSuffix) }}"></script> --}}
  <script>
